...
from .forms import InvitationForm, PersonForm # Import custom forms
...
class InvitationAdmin(admin.ModelAdmin):
    form = InvitationForm # Use the custom InvitationForm
    list_display = (
...
class PersonAdmin(admin.ModelAdmin):
    form = PersonForm # Use the custom PersonForm
...
class AssignmentAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['horizontal_filters'] = {
            ...
            'current_is_gift_handler': request.GET.get('is_gift_handler', ''),
        }
